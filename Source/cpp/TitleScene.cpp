...
Scene* TitleScene::Update()
{
	...
	case 3://出会ったおばけたち
		...
		if ((GetMouseInput() & MOUSE_INPUT_LEFT) && 
			...
			MouseY >= 330 + (int)(windOffset * 2) && 430 + (int)(windOffset * 2) &&
			BottunCoolTime == 0)
		{
			DispGhostType--;
			BottunCoolTime = 10;
...
void TitleScene::Render()
{
	...
	case 1://メニュー画面
		...
		case 2:
			...
			case 1:
				...
				DrawBox(150, 220 + (int)(windOffset * 2), 300, 250 + (int)(windOffset * 2), GetColor(255, 0, 0), FALSE);
				DrawBox(300, 220 + (int)(windOffset * 2), 310, 250 + (int)(windOffset * 2), GetColor(255, 0, 0), TRUE);
				Master::shot->NumDraw(3, 100, 100);//でない
	...
	case 3:
			...
			{
				DrawExtendGraph(400, 330 + (int)(windOffset * 2), 480, 430 + (int)(windOffset * 2), LeftGraphHandle, TRUE);
			}
			...
			{
				DrawExtendGraph(800, 330 + (int)(windOffset * 2), 880, 430 + (int)(windOffset * 2), RightGraphHandle, TRUE);
			}
